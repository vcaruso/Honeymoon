    ...
    var body: some View {
        VStack {
                        ...
                        .overlay(
                            ZStack {
                                ...
                                Image(systemName: "x.circle")
                                    ...
                                    .opacity(self.dragState.translation.width < -dragAreaTreshold && self.isTopCard(cardView: cardview) ? 1.0 : 0.0)
                        ...
                        .gesture(LongPressGesture(minimumDuration: 0.01)
                            ...
                            .updating(self.$dragState, body: { (value, state, transaction) in
                                ...
                                .onChanged({(value) in
                                    ...
                                    if drag.translation.width < -dragAreaTreshold {
                                ...
                                .onEnded({(value) in
                                    ...
                                    if drag.translation.width < -dragAreaTreshold || drag.translation.width > dragAreaTreshold {
            ...
            FooterView(showBookingAlert: $showAlert)
                .opacity(dragState.isDragging ? 0.0 : 1.1)
                .animation(.default)
